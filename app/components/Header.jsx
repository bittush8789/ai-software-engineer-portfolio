...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-2'>
      ...
      className='text-3xl sm:text-4xl lg:text-[50px] font-Ovo'>A self-taught Software Developer, with an interest in CS.</motion.h1>
      <motion.p 
      initial={{ opacity: 0 }}
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-7 '>
          ...
          href='https://drive.google.com/file/d/1Oos_R3QT0dhjDAH4fj_QzJD_b4uctT_2/view?usp=sharing' download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>My resume<Image src={assets.download_icon} alt='' className='w-4'/></motion.a>
      </div>
