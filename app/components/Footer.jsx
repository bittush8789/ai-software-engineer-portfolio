    ...
    <div className='mt-20'>
        <div className='text-center'>
              ...
              <div className='w-max flex items-center gap-2 mx-auto'>
                 ...
                 <a href="mailto:bittush9534@gmail.com" className="hover:underline">bittush9534@gmail.com</a>
              </div>
        </div>
        ...
        <div className='text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] py-6 mt-12'>
            ...
            <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                <li><a target='_blank' href='https://www.linkedin.com/in/bittu-kumar-54ab13254/'>LinkedIn</a></li>
                <li><a target='_blank' href='https://github.com/bittush8789'>Github</a></li>
                <li><a target='_blank' href='https://bittublog.hashnode.dev/'>Hashnode</a></li>
